    ...
    <header className="bg-red-700 text-white p-4 flex justify-between items-center">
      ...
      <nav className="flex-grow mx-4">
        <ul className="flex justify-center space-x-4">
          <li><Link to="/films" className="text-red-500 hover:text-red-500 font-bold">FILMS</Link></li>
          <li><Link to="/series" className="hover:text-yellow-500 font-bold">SÉRIES</Link></li>
