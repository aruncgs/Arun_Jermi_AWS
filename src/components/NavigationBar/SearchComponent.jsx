  ...
  return (
    <div className="flex flex-col items-center mt-5 relative">
      <input
        ...
        className="p-2.5 w-72 bg-black text-white border-2 border-white rounded-md text-center focus:outline-none focus:ring-2 focus:ring-gray-500 hover:bg-gray-600 transition-colors duration-200 ease-in-out input-placeholder"
      />
